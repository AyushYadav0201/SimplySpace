...
const About = () => {
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      Introducing "SimplySpace," the ultimate destination for effortlessly finding the ideal office space for your business needs. Whether you're in search of a new workspace to rent, looking to buy commercial property, or aiming to sell your existing office space, SimplySpace provides a seamless and intuitive platform tailored to your real estate requirements.
      </p>
      <p className="mb-4 text-slate-700">
